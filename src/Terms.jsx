  ...
  return (
    <div className="min-h-screen bg-paper text-ink px-6 py-24 max-w-3xl mx-auto">
      ...
      <p className="font-body text-muted leading-relaxed mb-4">
        This website provides general information about Paradiso Plumbing's services. Quotes
        provided through this site are estimates only and are subject to an in-person or phone
