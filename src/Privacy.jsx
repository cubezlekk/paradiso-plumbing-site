  ...
  return (
    <div className="min-h-screen bg-paper text-ink px-6 py-24 max-w-3xl mx-auto">
      ...
      <p className="font-body text-muted leading-relaxed mb-4">
        Paradiso Plumbing collects only the information you submit through our contact form
        (name, email, phone, address, and message) in order to respond to your inquiry. We do
